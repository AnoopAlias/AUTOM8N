...
if form.getvalue('poolfile') and form.getvalue('section'):
    ...
    if os.path.isfile(myphpini):
        ...
        for mykey in myconfig.keys():
            ...
            print(mykey)
            print('			</label>')
            print('			<form class="m-0 modalForm10-wrap" id="modalForm10'+'-'+str(mykeypos)+'" action="save_phpfpm_pool_file.cgi" onsubmit="return false;" method="post">')
            ...
            print('					</form>')
            print('					<form class="m-0 modalForm9-wrap" id="modalForm9'+'-'+str(mykeypos)+'" action="save_phpfpm_pool_file.cgi" onsubmit="return false;" method="post">')
