...
if form.getvalue('ddos'):
    if form.getvalue('ddos') == 'enable':
        ...
        if exists = os.path.isfile('/opt/nDeploy/conf/firehol'):
         subprocess.call('service firehol restart')
        ...
        print('<span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> DDOS Mitigation is now enabled')
        print('</div>')
        print('</div>')  # marker6
        print('</div>')
        ...
        print('<div class="panel-body">')  # marker6
        print('<div class="icon-box">')
        print('<span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> DDOS Mitigation is now disabled')
        print('</div>')
        print('</div>')  # marker6
        print('</div>')
else:
