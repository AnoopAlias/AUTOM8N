...
if form.getvalue('user'):
    ...
    print(('<div class="panel-heading"><h3 class="panel-title">Rebuild gdnsd zone for:'+form.getvalue('user')+'</h3></div>'))
    print('<div class="panel-body">')  # marker6
    print('<div class="icon-box">')
    print('<span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> DNS zone synced')
    print('</div>')
    print('</div>')  # marker6
    print('</div>')
else:
