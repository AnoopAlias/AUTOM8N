...
if os.path.isfile('/etc/nginx/modules.d/testcookie_access.load'):
    ...
    print('                                            <input type="radio" name="test_cookie" value="disabled" id="TestCookieOff" autocomplete="off"> Uninstalled')
    print('                                        </label>')
else:
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="test_cookie" value="enabled" id="TestCookieOn" autocomplete="off"> Installed')
    print('                                        </label>')
    print('                                        <label class="btn btn-light active">')
...
if os.path.isfile('/etc/nginx/modules.d/zz_modsecurity.load'):
    ...
    print('                                        </label>')
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="mod_security" value="disabled" id="TestCookieOff" autocomplete="off"> Uninstalled')
    print('                                        </label>')
else:
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="mod_security" value="enabled" id="TestCookieOn" autocomplete="off"> Installed')
    print('                                        </label>')
    print('                                        <label class="btn btn-light active">')
...
if os.path.isfile('/etc/nginx/modules.d/pagespeed.load'):
    ...
    print('                                        </label>')
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="pagespeed" value="disabled" id="TestCookieOff" autocomplete="off"> Uninstalled')
    print('                                        </label>')
else:
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="pagespeed" value="enabled" id="TestCookieOn" autocomplete="off"> Installed')
    print('                                        </label>')
    print('                                        <label class="btn btn-light active">')
...
if os.path.isfile('/etc/nginx/modules.d/brotli.load'):
    ...
    print('                                        </label>')
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="brotli" value="disabled" id="TestCookieOff" autocomplete="off"> Uninstalled')
    print('                                        </label>')
else:
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="brotli" value="enabled" id="TestCookieOn" autocomplete="off"> Installed')
    print('                                        </label>')
    print('                                        <label class="btn btn-light active">')
...
if os.path.isfile('/etc/nginx/modules.d/geoip2.load'):
    ...
    print('                                        </label>')
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="geoip2" value="disabled" id="TestCookieOff" autocomplete="off"> Uninstalled')
    print('                                        </label>')
else:
    print('                                        <label class="btn btn-light">')
    print('                                            <input type="radio" name="geoip2" value="enabled" id="TestCookieOn" autocomplete="off"> Installed')
    print('                                        </label>')
    print('                                        <label class="btn btn-light active">')
