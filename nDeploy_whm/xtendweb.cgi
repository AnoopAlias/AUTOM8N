...
print(('					            <input class="hidden" name="action" value="nginxreload">'))
...
print(('					            <input class="hidden" name="action" value="watcherrestart">'))
...
if os.path.isfile(cluster_config_file):
    ...
    print('					<form class="form mb-3" id="toastForm26" onsubmit="return false;">')
    print(('					<input class="hidden" name="mode" value="reset">'))
