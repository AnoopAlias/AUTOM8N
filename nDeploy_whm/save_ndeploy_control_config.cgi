...
if form.getvalue('breadcrumb_active_color') and form.getvalue('heading_background_color') and form.getvalue('heading_foreground_color') and form.getvalue('heading_height') and form.getvalue('header_button_color') and form.getvalue('icon_height') and form.getvalue('logo_not_icon') and form.getvalue('logo_width') and form.getvalue('logo_height') and form.getvalue('logo_url') and form.getvalue('app_title') and form.getvalue('app_email') and form.getvalue('body_background_color') and form.getvalue('text_color') and form.getvalue('card_color'):
