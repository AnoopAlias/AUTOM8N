...
fpm -s dir -t rpm -C ../nDeploy-unison-pkg --vendor "Anoop P Alias" --version ${UNISON_VERSION} --iteration ${UNISON_RPM_ITER} -a $(arch) -m anoopalias01@gmail.com -e --description "nDeploy custom unison package" --url http://anoopalias.github.io/nDeploy/ --conflicts unison --name unison-nDeploy .
