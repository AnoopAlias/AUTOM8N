...
rsync -av gnusys-monitoring-* root@gnusys.net:/usr/share/nginx/html/CentOS/7/x86_64/
cd ..
...
rsync -av gnusys-monitoring-* root@gnusys.net:/usr/share/nginx/html/CentOS/6/x86_64/
cd ..
