...
print('<li><a href="xtendweb.live.py">Select Domain</a></li><li class="active">View NGINX log</li>')
print('</ol>')
...
if os.path.isfile(nginx_log):
    ...
    print('<div class="alert alert-danger"><span class="glyphicon glyphicon-alert" aria-hidden="true"></span>NGINX log file is not present</div>')
