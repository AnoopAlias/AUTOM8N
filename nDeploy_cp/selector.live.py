...
if form.getvalue('domain'):
    ...
    print('<input class="btn btn-primary" data-toggle="tooltip" title="content optimizations / redirections / server headers etc." type="submit" value="SERVER SETTINGS">')
    ...
    print('<input class="btn btn-primary" data-toggle="tooltip" title="application server / version / application template etc." type="submit" value="APPLICATION SETTINGS">')
    # Pass on the domain name to the next stage
    print(('<input class="hidden" name="domain" value="'+mydomain+'">'))
    print('</form>')
    print('</div>')
