...
print('<li><a href="xtendweb.live.py">Set Domain</a></li><li class="active">Application Settings</li>')
print('</ol>')
...
if form.getvalue('domain') and form.getvalue('backend'):
    ...
    if os.path.isfile(profileyaml):
        ...
        if backend_category == 'PROXY':
            ...
            print(('<div class="col-sm-6"><div class="label label-warning">'+apptemplate_description+'</div></div>'))
            print('</div>')
            print('</li>')
            print('</ul>')
        else:
            ...
            print('<div class="col-sm-6"><div class="label label-warning">'+backend_version+'</div></div>')
            print('</div>')
            print('</li>')
            print('<li class="list-group-item">')
            print('<div class="row">')
            ...
            print('</li>')
        print('</ul>')
        print(('<div class="alert alert-success alert-top">You selected <span class="label label-success">'+mybackend+'</span> as the new backend, select the version and template for this backend below</div>'))
