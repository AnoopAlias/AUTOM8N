...
def print_header(title=''):
    ...
    if logo_not_icon == 'enabled':
        print('                    <a href="xtendweb.live.py"><img border="0" src="'+logo_url+'" width="'+logo_width+'" height="'+logo_height+'"></a>')
    else:
        print('                    <a href="xtendweb.live.py"><img border="0" src="'+brand_logo+'" width="'+icon_width+'" height="'+icon_height+'"></a>'+brand)
    print('                </h4>')
    print('            </div>')
...
def bcrumb(pagename="Unnamed Page",active_fa_icon="fas fa-infinity"):
    ...
    if pagename != 'Home':
        ...
        print('                    <li class="breadcrumb-item active" aria-current="page"><a style="color:'+breadcrumb_active_color+' !important;" href="xtendweb.live.py"><i class="fas fa-infinity"></i>&nbsp;Home</a></li>')
    print('                </ol>')
    print('            </nav>')
    print('')
