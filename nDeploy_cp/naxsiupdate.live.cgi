...
if form.getvalue('domain'):
    ...
    if os.path.isfile(profileyaml):
        ...
        if form.getvalue('textcontent'):
            ...
            print('<p style="background-color:LightGrey">(!) Whitelist rules with errors will not be accepted</p>')
            print(('<p style="background-color:LightGrey">Whitelist Rules saved for activation:  '+mydomain+'</p>'))
        else:
