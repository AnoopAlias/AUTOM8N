...
if form.getvalue('domain'):
    ...
    if os.path.isfile(profileyaml):
        ...
        if backend_category == "RUBY":
            print(('<div class="alert alert-info alert-top">Detected <span class="label label-info">RUBY</span> project, specify your dependencies in <br> <kbd>'+ document_root +'/Gemfile</kbd></div>'))
        print(('<input class="hidden" name="domain" value="'+mydomain+'">'))
