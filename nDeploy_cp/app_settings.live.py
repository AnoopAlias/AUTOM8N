    ...
    if os.path.isfile(profileyaml):
        ...
        if backend_category == 'PROXY':
            if backend_version == 'httpd':
                print(('<div class="alert alert-default alert-top"><span class="label label-info">NGINX </span><span class="glyphicon glyphicon-circle-arrow-right" aria-hidden="true"></span> <span class="label label-info">'+backend_version+'</span>--<span class="label label-default">'+apptemplate_description+'</span>  <span class="label label-primary">.htaccess</span><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></div>'))
            else:
                print(('<div class="alert alert-default alert-top"><span class="label label-info">NGINX </span><span class="glyphicon glyphicon-circle-arrow-right" aria-hidden="true"></span> <span class="label label-info">'+backend_version+'</span>--<span class="label label-default">'+apptemplate_description+'</span>  <span class="label label-danger">.htaccess</span><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></div>'))
        else:
            print(('<div class="alert alert-default alert-top"><span class="label label-info">NGINX </span><span class="glyphicon glyphicon-circle-arrow-right" aria-hidden="true"></span> <span class="label label-info">'+backend_version+'</span>--<span class="label label-default">'+apptemplate_description+'</span>  <span class="label label-danger">.htaccess</span><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></div>'))
