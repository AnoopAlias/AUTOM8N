...
if form.getvalue('domain'):
    ...
    if os.path.isfile(profileyaml):
        ...
        if backend_category == 'PROXY':
            ...
            print(('<div class="alert alert-info alert-top">You have deployed  <span class="label label-info">'+apptemplate_description+'</span> project on native <span class="label label-info">NGINX</span> with <span class="label label-info">'+backend_category+'</span> <span class="label label-info">'+backend_version+'</span> application server</div>'))
        print('</ul>')
