...
if 'domain' in form.keys():
    ...
    print_error('Error: Forbidden::domain')
    sys.exit(0)
...
if os.path.isfile(profileyaml):
    ...
    print_error('Error: Domain data file i/o error')
    sys.exit(0)
    ...
    if subdir_apps_dict:
        if subdir_apps_dict.get(thesubdir):
            ...
            if 'auth_basic' in form.keys():
                ...
                print_error('Error: Forbidden::auth_basic')
                sys.exit(0)
            # mod_security
            ...
            print_error('Missing subdir::'+thesubdir+' in domain data')
    else:
        print_error('Missing subdir_apps section in domain data')
else:
