    ...
    if os.path.isfile(profileyaml):
        ...
        if subdir_apps:
            ...
            for thesubdir in subdir_apps.keys():
                ...
                print('<center><input type="submit" value="Edit SubDir App Settings"></center>')
                print('</form>')
                print('<form action="subdir_delete.live.py">')
                print(('<input style="display:none" name="domain" value="'+mydomain+'">'))
                print(('<input style="display:none" name="thesubdir" value="'+thesubdir+'">'))
                print('<center><input type="submit" value="Delete Subdir Application"></center>')
                print('</form>')
                print('</div>')
        print('<HR>')
