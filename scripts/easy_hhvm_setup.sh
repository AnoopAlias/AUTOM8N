...
#  grep "hhvm_ghost_hunter.py" /etc/crontab || echo "0 */6 * * * /opt/nDeploy/scripts/hhvm_ghost_hunter.py" >> /etc/crontab
#  systemctl restart crond
#  echo -e '\e[93m ::WARNING:: Using binary HHVM from third party software mirrors \e[0m'
#  echo -e '\e[93m HHVM setup : OK \e[0m'
#fi
echo -e '\e[93m HHVM application server support is deprecated -- https://hhvm.com/blog/2017/09/18/the-future-of-hhvm.html \e[0m'
