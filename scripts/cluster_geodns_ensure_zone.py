...
if __name__ == "__main__":
    ...
    parser.add_argument("CLUSTER_ENABLE")
    args = parser.parse_args()
    thezone = args.ZONENAME
    myip = args.IPADDRESS
    cluster_enable = args.CLUSTER_ENABLE
    if cluster_enable == 1:
    ...
    cluster_ensure_zone(thezone, myip, serverlist, cluster_data_yaml_parsed, xtendweb_dns_cluster)
