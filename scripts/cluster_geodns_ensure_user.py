    ...
    for rr in resource_record:
        ...
        if rr["type"] == "NS":
            ...
            if rr["name"] == zone_name+".":
                ...
                the_geozone["data"][rr["name"].rstrip(zone_name+".")] = {}
                the_geozone["data"][rr["name"].rstrip(zone_name+".")]["a"] = []
                the_geozone["data"][rr["name"].rstrip(zone_name+".")]["a"].append(the_geozone_additional_a)
        elif rr["type"] == "TXT":
