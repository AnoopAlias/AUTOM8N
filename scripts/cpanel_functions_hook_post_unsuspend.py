...
if os.path.exists(cluster_config_file):
    subprocess.call("systemctl restart maxscale", shell=True)
    subprocess.call('ansible -i /opt/nDeploy/conf/nDeploy-cluster/hosts ndeploymaster -m shell -a "systemctl restart maxscale"', shell=True)
