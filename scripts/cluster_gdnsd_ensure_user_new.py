...
if __name__ == "__main__":
    ...
    try:
        ...
        print("parked_domains: "+str(parked_domains))
        print("addon_domains_dict: "+str(addon_domains_dict))
        print("sub_domains: "+str(sub_domains))
        ...
        print("GENERATING for MAIN DOMAIN")
        ...
        for the_parked_domain in parked_domains:
            ...
            print("tldextract:parked: "+extpark)
