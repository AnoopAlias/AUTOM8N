...
/usr/local/cpanel/scripts/uninstall_plugin /opt/nDeploy/nDeploy_cp --theme=paper_lantern
...
/usr/local/cpanel/scripts/install_plugin /opt/nDeploy/nDeploy_cp --theme=paper_lantern
/usr/local/cpanel/scripts/install_plugin /opt/nDeploy/nDeploy_cp --theme=jupiter
