...
XtendWeb only supports HHVM running as a single user (nobody) using a single process .The recommended way
...
::
  ...
  /opt/nDeploy/scripts/update_backend.py add HHVM_NOBODY hhvm /var/run/hhvm/hhvm.sock
