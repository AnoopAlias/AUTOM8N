...
print('<a href="phpfpm_selector.live.py" data-toggle="tooltip" data-placement="bottom" title="Start Over"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a>')
...
if os.path.isfile(installation_path+'/conf/PHPFPM_SELECTOR_ENABLED'):
    ...
    print('<form class="form-inline" action="select_php_settings.live.py" method="post">')
